...
class MathHelper
{
 public:
  ...
  static void MotionMatrixToParams(const cv::Mat& Rt, std::array<double,4>& quaternion,
                                   std::array<double,3>& translation);
  static void PrintMotion(const cv::Mat& Rt);
...
inline
void MathHelper::PrintMotion(const cv::Mat& Rt) {
  std::array<double,4> q;
  std::array<double,3> t;
  MotionMatrixToParams(Rt, q, t);
  std::cout << "R = [";
...
inline
void MathHelper::MotionMatrixToParams(const cv::Mat& Rt, std::array<double,4>& quaternion,
                                      std::array<double,3>& translation) {
  translation[0] = Rt.at<double>(0,3);
  translation[1] = Rt.at<double>(1,3);
  translation[2] = Rt.at<double>(2,3);
