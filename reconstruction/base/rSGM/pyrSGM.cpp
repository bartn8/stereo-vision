...
static PyObject *_matchWTARight_SSE(PyObject *self, PyObject *args)
{
    //void matchWTA_SSE(float32* dispImg, uint16* &dsiAgg, const sint32 width, const sint32 height, 
    //const sint32 maxDisp, const float32 uniqueness);
    ...
    matchWTARight_SSE(dispImg_mm, dsiAgg_mm, (sint32)width, (sint32)height, 
    (sint32) (dispCount-1), uniqueness);
...
static PyMethodDef rSGMMethods[] = {
    ...
    {"matchWTARight_SSE", _matchWTARight_SSE, METH_VARARGS, "Winner takes all with SSE optimization (Right)"},
